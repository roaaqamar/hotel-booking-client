  ...
  return room && (
    <div className='pt-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        shadow-[0px_0px_20Px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl' >
            ...
            md:gap10 text-gray-500'>

                <div className='flex flex-col'>
                    <label htmlFor="checkInDate" className='font-medium'>Check-In</label>
                    <input type="date" id='checkInDate' placeholder='CheckIn'
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='checkOutDate' placeholder='CheckOut'
                    className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
            ...
            active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6
